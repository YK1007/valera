...
import valera.offline.util.Arrays;
import valera.offline.util.Streams;
...
final class ChunkedInputStream extends AbstractHttpInputStream {
    ...
    ChunkedInputStream(InputStream is, CacheRequest cacheRequest) throws IOException {
        //super(is, httpEngine, cacheRequest);
        super(is, cacheRequest);
    }
